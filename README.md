...
- `DCA Strategy` — доллар-кост-эвериджинг: базово покупаем 1000 $ в начале месяца, можно включить покупки только на «красных» свечах, добавить фильтр по скользящей (close ниже/выше MA) или 200-week MA и накапливать пропущенные взносы.
